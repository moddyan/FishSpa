...
namespace PaintCore
{
	...
	public class CwColor : MonoBehaviour
	{
		...
		public Color Color { set { if (color != value) { color = value; CwColorCounter.MarkAllDirty(); } } get { return color; } } [SerializeField] private Color color;
...
namespace PaintCore
{
	...
	public class CwColor_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			var markAllDirty = false;

			Draw("color", ref markAllDirty, "The color associated with this component and GameObject name.");
